...
/**
 *
 * AWS SDK. An extension for the phpBB Forum Software package.
 *
 * @copyright (c) 2018, Mark Gawler, https://github.com/markgawler
 * @license GNU General Public License, version 2 (GPL-2.0)
 *
 */

namespace mrfg\AwsSdk;

/**
 * AWS SDK Service info.
 */
class service
{
	/** @var \phpbb\user */
